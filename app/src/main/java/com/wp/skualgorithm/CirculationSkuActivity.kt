 ...
 * 使用Sku循环求解法实现的demo
 */
class CirculationSkuActivity : AppCompatActivity() {
    private var currentSelectedSku: Sku? = null

    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_circulation_sku)
        ...
        val skuList = mock4DSkuList().apply {
            ...
            firstOrNull()?.let {
                ...
                //加载对应sku数据
                Glide.with(this@CirculationSkuActivity)
                    .load(it.skuImageUrl)
                    .centerCrop()
                    .into(ivSkuImage)
        ...
        //构造SkuCalculator
        val skuCalculator = CirculationSkuCalculator(
            specGroupList,
            skuList,
